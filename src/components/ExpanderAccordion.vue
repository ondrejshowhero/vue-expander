      ...
      return {
        ...
        items: [
          [
            ...
            'No, you can bike just as you’re used to. IT has been programmed with thousands of bike rides, and only reacts when a movement is distinctive of that of an accident.'
          ],
          [
